// name=tproxy/index.js
// Included tProxy wrapper (kept for reference). The main integration uses lib/index.js via tproxy-adapter.
const http = require('http');
const https = require('https');
const fs = require('fs');

// CONFIGURATION
const prefix = process.env.TPROXY_PREFIX || '/web';  // Set your prefix here
const localAddresses = [];  // Set your local addresses here
const blockedHostnames = [];  // Set your blocked hostnames here
const ssl = false;  // Set SSL configuration here
const port = process.env.TPROXY_PORT || 6969;  // Set the desired port
